...
Namespace UseScaleBreaks
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Dim seriesPoint1 As New DevExpress.XtraCharts.SeriesPoint("A", New Object() { (CObj(14R))})
			Dim seriesPoint2 As New DevExpress.XtraCharts.SeriesPoint("C", New Object() { (CObj(2006R))})
			Dim seriesPoint3 As New DevExpress.XtraCharts.SeriesPoint("D", New Object() { (CObj(16R))})
			Dim seriesPoint4 As New DevExpress.XtraCharts.SeriesPoint("F", New Object() { (CObj(2008R))})
